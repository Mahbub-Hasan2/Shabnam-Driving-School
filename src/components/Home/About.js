...
const About = () => {
    return (
        <div className='container mx-auto sm:px-6 px-2 sm:py-8'>
            <div className="py-2">
                <h2 className="text-2xl font-bold text-center text-primary py-10" >About Us</h2>
            </div>
            <div className="py-2">
                <div className="grid grid-cols-1 md:grid-cols-2 md:gap-5">
                    <div className="flex items-center">
                        <div className="">
                        <h2 className="text-3xl font-bold text-secondary">Welcome to Shabnam driving school: </h2>
