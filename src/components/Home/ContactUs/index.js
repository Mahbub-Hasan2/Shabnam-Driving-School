...
const ContactUs = () => {
    return (
        <div className="bg-[url('https://images.pexels.com/photos/7762717/pexels-photo-7762717.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')] w-full bg-cover bg-center md:h-screen h-full">
                    ...
                    <div className="grid grid-cols-5 gap-2">
                        <div className="md:col-span-3 col-span-5 flex items-center">
                            <div className="text-light">
                                ...
                                <p className=""> If you have any questions or comments about our driving courses, please fill out the form below and we will get back to you as soon as possible. Please make sure to provide accurate contact information so that we can reach you in a timely manner.</p>
